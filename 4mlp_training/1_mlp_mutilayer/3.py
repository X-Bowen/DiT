...
# class AdaptiveMLP(nn.Module):
#     def __init__(self, input_dim, num_classes, hidden_dim=512, dropout_rate=0.2):
#         super().__init__()
#         self.layers = nn.Sequential(
#             # First hidden layer
...
#             # Second hidden layer
#             nn.Linear(hidden_dim, hidden_dim // 2),  # Gradually reducing dimension
#             nn.BatchNorm1d(hidden_dim // 2),
#             nn.ReLU(),
#             nn.Dropout(dropout_rate/2),  # Reduce dropout in later layers
