...
BATCH_SIZE = 8192
EPOCHS = 50
# LEARNING_RATES = [1e-4, 2e-4, 3e-4, 4e-4, 5e-4, 6e-4, 7e-4, 8e-4, 9e-4, 1e-3]
LEARNING_RATES = [1e-4, 3e-4, 4e-4, 5e-4, 8e-4, 1e-3, 3e-3, 5e-3]  # Multiple learning rates to test
